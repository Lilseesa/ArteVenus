    ...
    <div class=container>
        ...
        <div class="container">
            ...
            <div class="row prod_main_titles">
                <h1 class="prod_elements prod_title">Productos</h1>
            </div>
            ...
            <div class="row mt-5 prod_main_content hm_boder-radius-section" >
                <div class="row">
                    ...
                    <div class="prod_containerHeader">
                        <h1 class="prod_elements prod_subtitle">Ofertas especiales</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row mt-5 prod_main_content hm_boder-radius-section" >
                <div class="row">
                    <!-- Special offers Title -->
                    <div class="prod_containerHeader">
                        <h1 class="prod_elements prod_subtitle">Todos los productos</h1>
                    </div>
                </div>
            </div>
        </div>
